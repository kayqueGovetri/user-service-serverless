...
class Auth:
    ...
    def get_payload_to_jwt(self, aud: str, ref: str = None, exp: datetime = None, seconds: int = 84600) -> dict:
        return {
            "aud": aud,
    ...
    @staticmethod
    def generate_access_token(payload: dict, secret: str, algorithm: str = "HS256") -> bytes:
